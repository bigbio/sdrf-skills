...
- NEVER modify the SDRF content during the contribution step (that's what `/sdrf-skills:sdrf-fix` and `/sdrf-skills:sdrf-annotate <file.sdrf.tsv> (review mode)` are for)
